...
namespace ImageClassifierAppUWP
{
    ...
    public sealed class classifierModel
    {
        ...
        public static async Task<classifierModel> CreateFromStreamAsync(IRandomAccessStreamReference stream, LearningModelDeviceKind deviceKind)
        {
            ...
            LearningModelDevice device = new LearningModelDevice(deviceKind);
            Debug.WriteLine($"Device kind: {deviceKind}");
