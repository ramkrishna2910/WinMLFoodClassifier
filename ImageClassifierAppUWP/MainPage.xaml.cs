...
namespace ImageClassifierAppUWP
{
    public sealed partial class MainPage : Page
    {
        ...
        private LearningModelDeviceKind deviceKind = LearningModelDeviceKind.Cpu;
        ...
        private void RadioButton_Checked(object sender, RoutedEventArgs e)
        {
            ...
            switch (rb.Name)
            {
                ...
                case "toggleButtonB":
                    ...
                    break;
                case "toggleButtonC":
                    deviceKind = LearningModelDeviceKind.DirectXHighPerformance;
                    break;
                case "toggleButtonD":
                    deviceKind = LearningModelDeviceKind.DirectXMinPower;
                    break;
            }
        }
        ...
        private async Task loadModel()
        {
            ...
            modelGen = await classifierModel.CreateFromStreamAsync(modelFile, deviceKind);
        }
        ...
        private async void OpenFileButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            await evaluate();
            // Extract the results
            Debug.WriteLine($"Executing...Device kind: {deviceKind}");
            extractResult();
            // Display the results  
            await displayResult();
        }
        ...
        private async Task evaluate()
        {
            ...
            _stopwatch.Stop();
            executionTime = _stopwatch.ElapsedMilliseconds/100;
        }
        ...
        private void extractResult()
        {
            ...
            result = keyOfMax;
            resultProbability = maxProbability*100;
        }
        ...
        private async Task displayResult()
        {
            ...
            displayExecutionTime.Text = executionTime.ToString();
            displayHardware.Text = deviceKind.ToString();
        }
    }
}